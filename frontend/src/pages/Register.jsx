      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-2 text-center text-sm text-brand-gray dark:text-zinc-400">
            Join PinSphere to find your next creative spark
          </p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          <div className="space-y-4 rounded-md">
            <div>
              <label htmlFor="username" className="text-xs font-semibold text-brand-dark dark:text-zinc-300 uppercase tracking-wider">
                Username
              </label>
              <div className="relative mt-1">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <User className="h-5 w-5 text-brand-gray dark:text-zinc-400" />
                </div>
                <input
                  id="username"
                  name="username"
